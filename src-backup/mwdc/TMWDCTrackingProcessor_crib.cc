/**
 * @file   TMWDCTrackingProcessor_crib.cc
 * @brief
 *
...
#include "TMWDCTrackingProcessor_crib.h"
...
using art::TMWDCTrackingProcessor_crib;

ClassImp(art::TMWDCTrackingProcessor_crib);

// Default constructor
TMWDCTrackingProcessor_crib::TMWDCTrackingProcessor_crib()
...
void TMWDCTrackingProcessor_crib::Init(TEventCollection *col)
{
...
void TMWDCTrackingProcessor_crib::GenerateMatrix()
{
...
void TMWDCTrackingProcessor_crib::Process()
{
   {/* initialization */
      fStopwatch->Start();
...
void TMWDCTrackingProcessor_crib::ProcessOne(const std::vector<std::vector<TMWDCHitData*> >& planeData)
{
   fNPlaneValid = 0;
   fCombinator->Clear();
   for (Int_t iPlane = 0; iPlane != fNPlane; ++iPlane) {
...
Int_t TMWDCTrackingProcessor_crib::FindBestCombination(TMWDCTrackingResult *tr)
{
...
Bool_t TMWDCTrackingProcessor_crib::DataIsValid(const TMWDCHitData *planeData) const
{
   {
...
Bool_t TMWDCTrackingProcessor_crib::CombinationIsValid() const
{
   return kTRUE;
}

void TMWDCTrackingProcessor_crib::FindTrack(TMWDCTrackingResult *tr, Bool_t fillStat)
{
...
Double_t TMWDCTrackingProcessor_crib::CalcSSR(const std::vector<Double_t> &pos,
