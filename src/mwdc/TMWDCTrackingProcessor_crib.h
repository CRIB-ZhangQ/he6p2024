/**
 * @file   TMWDCTrackingProcessor_crib.h
 * @brief
 *
...
#ifndef TMWDCTRACKINGPROCESSOR_CRIB_H
#define TMWDCTRACKINGPROCESSOR_CRIB_H
...
namespace art {
   class TMWDCTrackingProcessor_crib;
...
class art::TMWDCTrackingProcessor_crib : public TProcessor {
public:
   typedef std::vector< std::vector<TMWDCHitData*> > planeSet_t;
   // Default constructor
   TMWDCTrackingProcessor_crib();
   virtual ~TMWDCTrackingProcessor_crib();
...
private:
   ...
   TMWDCTrackingProcessor_crib(const TMWDCTrackingProcessor_crib&);
   // Assignment operator (prohibited)
   TMWDCTrackingProcessor_crib& operator=(const TMWDCTrackingProcessor_crib&);


   ClassDef(TMWDCTrackingProcessor_crib,0) // processor for MWDC tracking
};

#endif // TMWDCTRACKINGPROCESSOR_CRIB_H
